...
# Assume that this is being called from the Python directory
...
if platform.system() == 'Windows':
   ...
   assert pFound and os.path.isfile(pFile), \
      "Python cannot find your " +pFile +".dll - put it in c:\\windows\\system32"
   try:
   ...
   pFound = find_library('fix_parser')
   assert pFound and os.path.isfile(pFound), \
      "Python cannot find your " +pFile +" - put in a dir on LD_LIBRARY_PATH"
   lib = cdll.LoadLibrary(pFile)
